...
class Reserve extends MY_Controller
{
    ...
    public function contractFdd($resident)
    {
        ...
        $parameters     = array(
            ...
            'year_start'          => "{$resident->reserve_begin_time->year}",           //起租年
            'month_start'         => "{$resident->reserve_begin_time->month}",          //起租月
            'day_start'           => "{$resident->reserve_begin_time->day}",            //起租日
            'year_end'            => "{$resident->reserve_end_time->year}",             //结束年
            'month_end'           => "{$resident->reserve_end_time->month}",            //结束月
